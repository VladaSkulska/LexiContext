...
namespace LexiContext.Infrastructure.Migrations
{
    ...
    [Migration("20260629183646_InitClassroomArchitecture")]
    partial class InitClassroomArchitecture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LexiContext.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthProvider = "System",
                            CreatedAt = new DateTime(2026, 6, 29, 18, 36, 46, 438, DateTimeKind.Utc).AddTicks(7072),
                            CurrentStreak = 0,
                            Email = "student@fpm.kpi.ua",
                            ExternalProviderId = "sys-001",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 6, 29, 18, 36, 46, 438, DateTimeKind.Utc).AddTicks(7073),
                            Username = "DevStudent_KPI"
                        });
                });

            modelBuilder.Entity("LexiContext.Domain.Entities.UserActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
